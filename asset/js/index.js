...
audioElement.addEventListener('timeupdate', function(e) {
    ...
    if(nowTime > 78 && lastTime < 78){
        $('#line-eleven').toggleClass('pushSoftIn hidden');
        $('#withyou2').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 83 && lastTime < 83){
        $('#line-twelfth').toggleClass('pushSoftIn hidden');
        $('#line-eleven').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 90 && lastTime < 90){
         
        $('#line-twelfth').toggleClass('pushSoftIn pushSoftOut');
    }

    if(nowTime > 112 && lastTime < 112){
        $('#line-thirteen').toggleClass('pushSoftIn hidden');
        // $('#line-twelfth').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 118 && lastTime < 118){
        $('#line-fourteen').toggleClass('pushSoftIn hidden');
        $('#line-thirteen').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 124 && lastTime < 124){
        $('#line-fifteen').toggleClass('pushSoftIn hidden');
        $('#line-fourteen').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 129.5 && lastTime < 129.5){
        $('#line-sixteen').toggleClass('pushSoftIn hidden');
        $('#line-fifteen').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 134.5 && lastTime < 134.5){
        $('#line-seventeen').toggleClass('pushSoftIn hidden');
        $('#line-sixteen').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 139.5 && lastTime < 139.5){
        $('#line-eighteen').toggleClass('pushSoftIn hidden');
        $('#line-seventeen').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 145.5 && lastTime < 145.5){
        $('#line-nineteen').toggleClass('pushSoftIn hidden');
        $('#line-eighteen').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 151.5 && lastTime < 151.5){
        $('#line-twenty').toggleClass('pushSoftIn hidden');
        $('#line-nineteen').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 157 && lastTime < 157){
        $('#line-twenty-one').toggleClass('pushSoftIn hidden');
        $('#line-twenty').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 162 && lastTime < 162){
        $('#line-twenty-two').toggleClass('pushSoftIn hidden');
        $('#line-twenty-one').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 168 && lastTime < 168){
        $('#line-twenty-three').toggleClass('pushSoftIn hidden');
        $('#line-twenty-two').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 173 && lastTime < 173){
        $('#line-twenty-four').toggleClass('pushSoftIn hidden');
        $('#line-twenty-three').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 180 && lastTime < 180){
         
        $('#line-twenty-four').toggleClass('pushSoftIn pushSoftOut');
    }

    if(nowTime > 185 && lastTime < 185){
        $('#line-twenty-five').toggleClass('pushSoftIn hidden');
    }
    if(nowTime > 190 && lastTime < 190){
        $('#line-twenty-six').toggleClass('pushSoftIn hidden');
        $('#line-twenty-five').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 196 && lastTime < 196){
        $('#line-twenty-seven').toggleClass('pushSoftIn hidden');
        $('#line-twenty-six').toggleClass('pushSoftIn pushSoftOut');
    }
    if(nowTime > 208 && lastTime < 208){
        
        $('#line-twenty-seven').toggleClass('pushSoftIn pushSoftOut');
    }
